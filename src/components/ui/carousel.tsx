...
function CarouselPrevious({ className, variant = "outline", size = "icon", ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "hidden md:inline-flex absolute size-10 rounded-full",
        orientation === "horizontal" ? "top-1/2 -left-[-25px] -translate-y-1/2" : "-top-12 left-1/2 -translate-x-1/2 rotate-90",
        className
      )}
...
function CarouselNext({ className, variant = "outline", size = "icon", ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    <Button
      ...
      className={cn(
        "hidden md:inline-flex absolute size-10 rounded-full",
        orientation === "horizontal" ? "top-1/2 -right-[-25px] -translate-y-1/2" : "-bottom-12 left-1/2 -translate-x-1/2 rotate-90",
        className
      )}
